    ...
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        <form style={{ marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap:'20px'}}  onSubmit={handleSubmit(onFinishHandler)}>
          <FormControl>
            <FormHelperText sx={{fontWeight: 700, margin: '10px', fontSize: 16, color: '#11142D'}}>
              Enter property name
            </FormHelperText>
          ...
          <FormControl>
            ...
            <TextareaAutosize minRows={5} required placeholder='Write description here...' color="info" style={{width: '100%', background: 'transparent', fontSize: '16px', borderColor: 'rgba(0,0,0,0.23)', borderRadius: 6, padding: 10, color: '#919191' }} {...register('description', { required: true})}/>
          </FormControl>
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              <Typography color="#11142d" fontSize={16} fontWeight={500} my="10px">Property Photos</Typography>
              <Button component="label" sx={{ width:'fit-content', color:"#2ED480", textTransform:'capitalize', fontSize: 16}}>Upload *
